  ...
  if (post !== undefined) {
    for (let content of post.contents) {
      if (content.type === 'p') {
        ...
        const url = `https://github.com/July249/jibro-blog/blob/main/public${content.src}?raw=true`;
              ...
              <section className="wrap-box">
                <div className="inner">
                  <dl className="author-wrap">
                    ...
                    <dd className="author">
                      <img
                        src="https://github.com/July249/jibro-blog/blob/main/src/assets/profile.jpg?raw=true"
                        alt=""
                      />{' '}
                      {post.userName}
                    </dd>
                  ...
                  <hr />
                  <div className="view-contents">{renderingContents}</div>
